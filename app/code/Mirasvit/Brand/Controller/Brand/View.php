...
class View extends \Magento\Framework\App\Action\Action
{
    ...
    public function initCategory()
    {
        ...
        if (!$this->registry->registry(BrandPageConfig::BRAND_DATA)) {
    ...
    private function initBrand()
    {
        ...
        $this->registry->register(BrandPageConfig::BRAND_DATA, [
            BrandPageConfig::BRAND_ATTRIBUTE     => $brand->getAttributeCode(),
            BrandPageConfig::ATTRIBUTE_OPTION_ID => $brandOptionId,
            BrandPageConfig::BRAND_URL_KEY       => $brand->getUrl(),
            BrandPageConfig::BRAND_DEFAULT_NAME  => $brand->getLabel(),
            BrandPageConfig::BRAND_PAGE_ID       => $brand->getPage()->getId(),
        ], true);
