...
class HorizontalFilterOptions implements ArrayInterface
{
    ...
    /**
     * HorizontalFilterOptions constructor.
    ...
    private function getAdditionalFilters()
    {
        ...
        $filteredAdditionalAttributesOptions[] = [
            'value' => ExtraFiltersConfig::NEW_FILTER_FRONT_PARAM
                . HorizontalFilterOptions::HORIZONTAL_FILTER_CONFIG_SEPARATOR
                . '1',
            'label' => ExtraFiltersConfig::NEW_FILTER_DEFAULT_LABEL,
        ];

        $filteredAdditionalAttributesOptions[] = [
            'value' => ExtraFiltersConfig::ON_SALE_FILTER_FRONT_PARAM
                . HorizontalFilterOptions::HORIZONTAL_FILTER_CONFIG_SEPARATOR
                . '1',
            'label' => ExtraFiltersConfig::ON_SALE_FILTER_DEFAULT_LABEL,
        ];

        $filteredAdditionalAttributesOptions[] = [
            'value' => ExtraFiltersConfig::STOCK_FILTER_FRONT_PARAM
                . HorizontalFilterOptions::HORIZONTAL_FILTER_CONFIG_SEPARATOR
                . '1',
            'label' => ExtraFiltersConfig::STOCK_FILTER_DEFAULT_LABEL,
        ];

        $filteredAdditionalAttributesOptions[] = [
            'value' => ExtraFiltersConfig::RATING_FILTER_FRONT_PARAM
                . HorizontalFilterOptions::HORIZONTAL_FILTER_CONFIG_SEPARATOR
                . '1',
            'label' => ExtraFiltersConfig::RATING_FILTER_DEFAULT_LABEL,
        ];
